...
public class Art5019injusticeModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modelsittingkrypto.LAYER_LOCATION, Modelsittingkrypto::createBodyLayer);
		event.registerLayerDefinition(Modelcape_frame_1.LAYER_LOCATION, Modelcape_frame_1::createBodyLayer);
		event.registerLayerDefinition(Modelemptymodel.LAYER_LOCATION, Modelemptymodel::createBodyLayer);
