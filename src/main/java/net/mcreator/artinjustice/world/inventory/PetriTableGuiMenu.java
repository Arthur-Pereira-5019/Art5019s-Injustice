...
import net.mcreator.artinjustice.network.PetriTableGuiSlotMessage;
...
public class PetriTableGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PetriTableGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(Art5019injusticeModMenus.PETRI_TABLE_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 9, 35) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			Art5019injusticeMod.PACKET_HANDLER.sendToServer(new PetriTableGuiSlotMessage(slotid, x, y, z, ctype, meta));
			PetriTableGuiSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
