...
public class TransmutationGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TransmutationGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
