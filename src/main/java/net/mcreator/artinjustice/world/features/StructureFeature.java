package net.mcreator.artinjustice.world.features;
...
import net.mcreator.artinjustice.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, Art5019injusticeMod.MODID);
