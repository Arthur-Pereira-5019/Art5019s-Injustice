...
package net.mcreator.artinjustice.world.features.treedecorators;
...
public class WarLandsLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(WarLandsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("war_lands_tree_leave_decorator", DECORATOR_TYPE));
	}

	public WarLandsLeaveDecorator() {
		super(0.25f);
	}
