...
public class WarLandsFruitDecorator extends CocoaDecorator {
	public static Codec<WarLandsFruitDecorator> CODEC = Codec.unit(WarLandsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("war_lands_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public WarLandsFruitDecorator() {
		super(0.2f);
	}
