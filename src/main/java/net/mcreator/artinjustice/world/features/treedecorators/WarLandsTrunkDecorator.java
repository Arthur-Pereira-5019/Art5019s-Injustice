...
public class WarLandsTrunkDecorator extends TrunkVineDecorator {
	public static Codec<WarLandsTrunkDecorator> CODEC = Codec.unit(WarLandsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("war_lands_tree_trunk_decorator", DECORATOR_TYPE));
	}
