...
public class AmethystLensesItem extends Item {
	public AmethystLensesItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("-64 Uses, doesn't is damaged by Tier 1 or lower researches"));
	}
