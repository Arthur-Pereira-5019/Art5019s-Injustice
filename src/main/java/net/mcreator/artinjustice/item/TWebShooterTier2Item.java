...
import net.mcreator.artinjustice.procedures.TWebShooterTier2ChooseFormProcedure;

import java.util.List;

public class TWebShooterTier2Item extends Item {
	public TWebShooterTier2Item() {
		super(new Item.Properties().durability(3200).rarity(Rarity.UNCOMMON));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TWebShooterTier2ChooseFormProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
