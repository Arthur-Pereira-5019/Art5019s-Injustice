...
public class MineralExtractionFormulaItem extends Item {
	public MineralExtractionFormulaItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Recipe: Any Element extracted from a Mineral"));
	}
