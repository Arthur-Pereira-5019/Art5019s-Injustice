...
public class KryptoniteKnifeItem extends SwordItem {
	public KryptoniteKnifeItem() {
		super(new Tier() {
			public int getUses() {
				return 180;
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Art5019injusticeModItems.KRYPTONITE_BLADE.get()));
			}
