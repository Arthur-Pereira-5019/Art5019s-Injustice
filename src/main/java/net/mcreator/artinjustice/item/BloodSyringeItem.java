...
import net.mcreator.artinjustice.procedures.BloodSyringeRightclickedProcedure;
...
public class BloodSyringeItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Sample: Unknown"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BloodSyringeRightclickedProcedure.execute(entity);
		return ar;
	}
}
