...
import net.mcreator.artinjustice.procedures.Test4Procedure;
...
public class Ability1Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Test4Procedure.execute(world, x, y, z, entity);
		}
		if (type == 1) {

			Ability1OnKeyReleasedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		Art5019injusticeMod.addNetworkMessage(Ability1Message.class, Ability1Message::buffer, Ability1Message::new, Ability1Message::handler);
	}
}
