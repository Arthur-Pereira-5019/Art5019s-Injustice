...
import net.mcreator.artinjustice.procedures.Ability5OnKeyPressedProcedure;
...
public class Ability5Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Ability5OnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		Art5019injusticeMod.addNetworkMessage(Ability5Message.class, Ability5Message::buffer, Ability5Message::new, Ability5Message::handler);
	}
}
