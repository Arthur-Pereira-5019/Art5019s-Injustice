...
import net.mcreator.artinjustice.procedures.Ability2OnKeyReleasedProcedure;
import net.mcreator.artinjustice.procedures.Ability2OnKeyPressedProcedure;
...
public class Ability2Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			Ability2OnKeyReleasedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		Art5019injusticeMod.addNetworkMessage(Ability2Message.class, Ability2Message::buffer, Ability2Message::new, Ability2Message::handler);
	}
}
