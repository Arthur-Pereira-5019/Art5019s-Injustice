...
public class ChemistryTableProduceMustardGasProcedure {
	public static double execute(LevelAccessor world, double x, double y, double z, Entity entity, double ck) {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 10)).getItem() == Art5019injusticeModItems.FORMULA_MUSTARD_BOTTLE.get()) {
			if (ck >= 1) {
				if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
					ItemStack _setstack = new ItemStack(Art5019injusticeModItems.MUSTARD_GAS_BOMB.get()).copy();
