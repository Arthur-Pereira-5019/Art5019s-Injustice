...
public class ArtTheUnemployedTaskManagementProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity, double parsedalignment, double pc, double quest, double step) {
		...
		if (entity instanceof ArtTheUnemployedEntity _datEntSetI)
			_datEntSetI.getEntityData().set(ArtTheUnemployedEntity.DATA_step, (int) step);
		if (entity instanceof ArtTheUnemployedEntity _datEntSetI)
			_datEntSetI.getEntityData().set(ArtTheUnemployedEntity.DATA_quest, (int) quest);
