...
public class LazarusPitWaterMobplayerCollidesBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity.getCapability(Art5019injusticeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new Art5019injusticeModVariables.PlayerVariables())).powerid != 0
				&& (world.getFluidState(BlockPos.containing(x, y, z)).createLegacyBlock()).getFluidState().isSource()) {
			if (ReturnCanResetOnLazarusPitProcedure.execute(entity)) {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.CLOUD, x, y, z, 40, 1, 1, 1, 1);
				...
				if (entity instanceof ServerPlayer _player) {
					Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("art5019injustice:back_to_life"));
