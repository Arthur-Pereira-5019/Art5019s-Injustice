...
public class PepperSeedsRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).is(BlockTags.create(new ResourceLocation("forge:any_air")))
			...
			world.setBlock(BlockPos.containing(x, y + 1, z), Art5019injusticeModBlocks.PEPPER_STAGE_1.get().defaultBlockState(), 3);
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(Art5019injusticeModItems.PEPPER_SEEDS.get());
