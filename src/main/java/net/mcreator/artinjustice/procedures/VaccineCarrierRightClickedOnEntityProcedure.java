...
public class VaccineCarrierRightClickedOnEntityProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (!(entity instanceof Player _plrCldCheck1 && _plrCldCheck1.getCooldowns().isOnCooldown((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()))) {
			...
			if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Art5019injusticeModItems.VACCINE_CARRIER.get()) {
				HerdImmunityProcedure.execute(world, x, y, z, entity);
				...
				HerdImmunityTipeIIProcedure.execute(world, x, y, z, entity);
			}
			if (sourceentity instanceof Player _player) {
