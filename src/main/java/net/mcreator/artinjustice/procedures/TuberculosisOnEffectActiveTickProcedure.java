...
public class TuberculosisOnEffectActiveTickProcedure {
		...
		if (Math.random() < 0.5) {
			if (Math.random() < 0.4) {
				...
				if (Math.random() < 0.45) {
					...
					if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(Art5019injusticeModMobEffects.TUBERCULOSIS.get()) ? _livEnt.getEffect(Art5019injusticeModMobEffects.TUBERCULOSIS.get()).getDuration() : 0) < 24000) {
						{
								...
								if (!((entityiterator instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("art5019injustice:gas_masks")))
									...
									if (!(entity == entityiterator)) {
										if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
											_entity.addEffect(new MobEffectInstance(Art5019injusticeModMobEffects.TUBERCULOSIS.get(), 120000, 0, false, false));
									}
								}
							}
						}
					} else if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(Art5019injusticeModMobEffects.TUBERCULOSIS.get()) ? _livEnt.getEffect(Art5019injusticeModMobEffects.TUBERCULOSIS.get()).getDuration() : 0) < 72000) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(Art5019injusticeModMobEffects.BLEEDING.get(), 200, 0, false, false));
					}
				} else {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
