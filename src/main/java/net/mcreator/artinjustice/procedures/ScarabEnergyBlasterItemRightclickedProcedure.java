...
public class ScarabEnergyBlasterItemRightclickedProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, float damage, int knockback) {
						AbstractArrow entityToSpawn = new ScarabEnergyBlasterProjectileEntity(Art5019injusticeModEntities.SCARAB_ENERGY_BLASTER_PROJECTILE.get(), level);
