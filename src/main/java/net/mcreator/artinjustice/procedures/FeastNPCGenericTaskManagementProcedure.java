...
public class FeastNPCGenericTaskManagementProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity, double parsedalignment, double pc, double quest, double step) {
		...
		if (entity instanceof FeastNPCEntity _datEntSetI)
			_datEntSetI.getEntityData().set(FeastNPCEntity.DATA_step, (int) step);
		if (entity instanceof FeastNPCEntity _datEntSetI)
			_datEntSetI.getEntityData().set(FeastNPCEntity.DATA_quest, (int) quest);
