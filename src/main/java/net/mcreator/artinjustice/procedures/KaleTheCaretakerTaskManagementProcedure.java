...
public class KaleTheCaretakerTaskManagementProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity, double parsedalignment, double pc, double quest, double step) {
		...
		if (entity instanceof KaleTheCaretakerEntity _datEntSetI)
			_datEntSetI.getEntityData().set(KaleTheCaretakerEntity.DATA_step, (int) step);
		if (entity instanceof KaleTheCaretakerEntity _datEntSetI)
			_datEntSetI.getEntityData().set(KaleTheCaretakerEntity.DATA_quest, (int) quest);
