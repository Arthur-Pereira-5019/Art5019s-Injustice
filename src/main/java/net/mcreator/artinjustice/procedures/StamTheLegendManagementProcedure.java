...
public class StamTheLegendManagementProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity, double parsedalignment, double pc, double quest, double step) {
		...
		if (entity instanceof StanTheLegendEntity _datEntSetI)
			_datEntSetI.getEntityData().set(StanTheLegendEntity.DATA_step, (int) step);
		if (entity instanceof StanTheLegendEntity _datEntSetI)
			_datEntSetI.getEntityData().set(StanTheLegendEntity.DATA_quest, (int) quest);
