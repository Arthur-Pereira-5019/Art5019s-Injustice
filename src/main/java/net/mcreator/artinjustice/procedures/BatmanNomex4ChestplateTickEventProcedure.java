...
public class BatmanNomex4ChestplateTickEventProcedure {
	public static void execute(Entity entity) {
		...
		} else if ((entity.getCapability(Art5019injusticeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new Art5019injusticeModVariables.PlayerVariables())).runningt >= 70) {
			{
				Entity _entity = entity;
				if (_entity instanceof Player _player) {
