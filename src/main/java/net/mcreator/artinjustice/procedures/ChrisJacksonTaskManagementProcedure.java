...
public class ChrisJacksonTaskManagementProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity, double parsedalignment, double pc, double quest, double step) {
		...
		if (entity instanceof ChrisTheMusicianEntity _datEntSetI)
			_datEntSetI.getEntityData().set(ChrisTheMusicianEntity.DATA_step, (int) step);
		if (entity instanceof ChrisTheMusicianEntity _datEntSetI)
			_datEntSetI.getEntityData().set(ChrisTheMusicianEntity.DATA_quest, (int) quest);
