...
public class BatmanNomex2ChestplateTickEventProcedure {
	public static void execute(Entity entity) {
		...
		if (!entity.isSprinting()) {
			{
				...
				if (_entity instanceof Player _player) {
					_player.getInventory().armor.set(2, new ItemStack(Art5019injusticeModItems.BATMAN_NOMEX_2_CHESTPLATE.get()));
					_player.getInventory().setChanged();
				} else if (_entity instanceof LivingEntity _living) {
					_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(Art5019injusticeModItems.BATMAN_NOMEX_2_CHESTPLATE.get()));
				}
			}
			{
		...
		} else if ((entity.getCapability(Art5019injusticeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new Art5019injusticeModVariables.PlayerVariables())).runningt >= 30) {
			{
				Entity _entity = entity;
				if (_entity instanceof Player _player) {
