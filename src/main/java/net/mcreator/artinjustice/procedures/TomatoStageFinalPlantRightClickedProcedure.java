...
public class TomatoStageFinalPlantRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _level) {
			ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Art5019injusticeModItems.TOMATO.get()));
		...
		}
		{
			...
			BlockState _bs = Art5019injusticeModBlocks.TOMATO_STAGE_4.get().defaultBlockState();
