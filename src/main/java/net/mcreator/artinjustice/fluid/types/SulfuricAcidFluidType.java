...
public class SulfuricAcidFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("art5019injustice:block/fluid_sulfuricacid_still"), FLOWING_TEXTURE = new ResourceLocation("art5019injustice:block/fluid_sulfuricacid_flow");
