...
import net.mcreator.artinjustice.procedures.PlagueZombieEntityIsHurtProcedure;
import net.mcreator.artinjustice.init.Art5019injusticeModItems;
import net.mcreator.artinjustice.init.Art5019injusticeModEntities;

public class PlagueZombieEntity extends Zombie {
	public PlagueZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(Art5019injusticeModEntities.PLAGUE_ZOMBIE.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Art5019injusticeModItems.CONTAMINED_HUMAN_REMAINS.get()));
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		PlagueZombieEntityIsHurtProcedure.execute(world, x, y, z, damagesource);
		return super.hurt(damagesource, amount);
	}

	public static void init() {
		SpawnPlacements.register(Art5019injusticeModEntities.PLAGUE_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
