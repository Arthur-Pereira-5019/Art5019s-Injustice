...
import net.mcreator.artinjustice.network.TodayProblemButtonMessage;
...
public class TodayProblemScreen extends AbstractContainerScreen<TodayProblemMenu> {
	private final static HashMap<String, Object> guistate = TodayProblemMenu.guistate;
	...
	public TodayProblemScreen(TodayProblemMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("art5019injustice:textures/screens/today_problem.png");
	...
	public void init() {
		super.init();
		n1 = new EditBox(this.font, this.leftPos + 9, this.topPos + 31, 118, 18, Component.translatable("gui.art5019injustice.today_problem.n1")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.art5019injustice.today_problem.n1").getString());
				else
					setSuggestion(null);
			}
		...
		n1.setSuggestion(Component.translatable("gui.art5019injustice.today_problem.n1").getString());
		n1.setMaxLength(32767);
		guistate.put("text:n1", n1);
		this.addWidget(this.n1);
		button_validate = Button.builder(Component.translatable("gui.art5019injustice.today_problem.button_validate"), e -> {
			if (true) {
				Art5019injusticeMod.PACKET_HANDLER.sendToServer(new TodayProblemButtonMessage(0, x, y, z));
				TodayProblemButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
