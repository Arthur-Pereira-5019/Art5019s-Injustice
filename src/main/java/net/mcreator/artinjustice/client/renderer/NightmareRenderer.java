...
public class NightmareRenderer extends HumanoidMobRenderer<NightmareEntity, HumanoidModel<NightmareEntity>> {
	...
	public ResourceLocation getTextureLocation(NightmareEntity entity) {
		return new ResourceLocation("art5019injustice:textures/entities/nightmare.png");
	}
}
