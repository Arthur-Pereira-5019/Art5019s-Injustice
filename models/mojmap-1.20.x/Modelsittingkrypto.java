...
public class Modelsittingkrypto<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sittingkrypto"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.4F)).texOffs(16, 14)
						.addBox(-3.0F, -5.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.4F)).texOffs(16, 14)
						.addBox(1.0F, -5.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.4F)).texOffs(0, 10)
						.addBox(-1.5F, -0.0156F, -6.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.4F)),
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(18, 14).addBox(-4.0F, -8.4645F, -13.1924F, 6.0F, 9.0F, 6.0F,
		...
		PartDefinition upperBody_r1 = upperBody.addOrReplaceChild("upperBody_r1",
				CubeListBuilder.create().texOffs(21, 0).addBox(-5.0F, -8.5F, -1.5F, 8.0F, 6.0F, 7.0F,
						new CubeDeformation(0.4F)),
		...
		PartDefinition leg0_r1 = leg0.addOrReplaceChild("leg0_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-3.5F, -8.0F, 6.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.4F)),
				PartPose.offsetAndRotation(2.5F, 0.0F, -11.0F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition leg1_r1 = leg1.addOrReplaceChild("leg1_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-0.5F, -8.0F, 6.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.4F)),
		...
		PartDefinition leg2_r1 = leg2.addOrReplaceChild("leg2_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-4.0F, -8.0F, -5.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.4F)),
		...
		PartDefinition leg3_r1 = leg3.addOrReplaceChild("leg3_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, -8.0F, -5.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.4F)),
		...
		PartDefinition tail_r1 = tail.addOrReplaceChild("tail_r1",
				CubeListBuilder.create().texOffs(9, 18).addBox(-2.0F, -3.0F, 6.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 12.0F, -8.0F, 1.1781F, 0.0F, 0.0F));
